...
WORKLOAD_DEFINITIONS = (
    ...
    WorkloadDefinition(
        name="mget_width_1",
        description="Read-only MGET workload with one key per command.",
        distribution="uniform",
        key_pattern="multi-key-width-1",
        read_ratio=100,
        write_ratio=0,
        multi_key=True,
        transactional=False,
    ...
    WorkloadDefinition(
        name="mget_width_16",
        description="Read-only MGET workload with sixteen keys per command.",
        distribution="uniform",
        key_pattern="multi-key-width-16",
        read_ratio=100,
        write_ratio=0,
        multi_key=True,
        transactional=False,
    ...
    WorkloadDefinition(
        name="mget_width_64",
        description="Read-only MGET workload with sixty-four keys per command.",
        distribution="uniform",
        key_pattern="multi-key-width-64",
        read_ratio=100,
        write_ratio=0,
        multi_key=True,
        transactional=False,
    ...
    WorkloadDefinition(
        name="mget_width_256",
        description="Read-only MGET workload with 256 keys per command.",
        distribution="uniform",
        key_pattern="multi-key-width-256",
        read_ratio=100,
        write_ratio=0,
        multi_key=True,
        transactional=False,
    ...
    WorkloadDefinition(
        name="exists_width_1",
        description="Read-only EXISTS workload with one key per command.",
        distribution="uniform",
        key_pattern="multi-key-width-1",
        read_ratio=100,
        write_ratio=0,
        ...
        transactional=False,
        hot_key=False,
        default_command_groups=("keys",),
        default_commands=("EXISTS",),
    ),
    WorkloadDefinition(
        name="exists_width_16",
        description="Read-only EXISTS workload with sixteen keys per command.",
        distribution="uniform",
        key_pattern="multi-key-width-16",
        read_ratio=100,
        write_ratio=0,
    ...
    WorkloadDefinition(
        name="exists_width_64",
        description="Read-only EXISTS workload with sixty-four keys per command.",
        distribution="uniform",
        key_pattern="multi-key-width-64",
        read_ratio=100,
        write_ratio=0,
    ...
    WorkloadDefinition(
        name="exists_width_256",
        description="Read-only EXISTS workload with 256 keys per command.",
        distribution="uniform",
        key_pattern="multi-key-width-256",
        read_ratio=100,
        write_ratio=0,
