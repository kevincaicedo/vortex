...
fn write_info_runtime(buf: &mut Vec<u8>, runtime: RuntimeMetricsSnapshot) {
    ...
    write_info_u64(
        buf,
        b"shared_nothing_accepted_remote:",
        runtime.shared_nothing_accepted_remote,
    );
    write_info_u64(
        buf,
        b"shared_nothing_remote_backpressure:",
        runtime.shared_nothing_remote_backpressure,
    );
    write_info_u64(
        buf,
        b"shared_nothing_reply_backpressure:",
        runtime.shared_nothing_reply_backpressure,
    );
    write_info_u64(
        buf,
        b"shared_nothing_deferred_replies:",
        runtime.shared_nothing_deferred_replies,
    );
    write_info_u64(
        buf,
        b"shared_nothing_wakeups_sent:",
        runtime.shared_nothing_wakeups_sent,
    );
    write_info_u64(
        buf,
        b"shared_nothing_wakeup_failures:",
        runtime.shared_nothing_wakeup_failures,
    );
    write_info_u64(
        buf,
        b"shared_nothing_aggregates_accepted:",
        runtime.shared_nothing_aggregates_accepted,
    );
    write_info_u64(
        buf,
        b"shared_nothing_aggregate_width_max:",
        runtime.shared_nothing_aggregate_width_max,
    );
    write_info_u64(
        buf,
        b"shared_nothing_txns_accepted:",
        runtime.shared_nothing_txns_accepted,
    );
    write_info_u64(
        buf,
        b"shared_nothing_txn_prepare_messages:",
        runtime.shared_nothing_txn_prepare_messages,
    );
    write_info_u64(
        buf,
        b"shared_nothing_txn_commit_messages:",
        runtime.shared_nothing_txn_commit_messages,
    );
    write_info_u64(
        buf,
        b"shared_nothing_txn_abort_messages:",
        runtime.shared_nothing_txn_abort_messages,
    );
    write_info_u64(
        buf,
        b"shared_nothing_txn_condition_aborts:",
        runtime.shared_nothing_txn_condition_aborts,
    );
    write_info_u64(
        buf,
        b"shared_nothing_txn_conflict_aborts:",
        runtime.shared_nothing_txn_conflict_aborts,
    );
    write_info_u64(
        buf,
        b"shared_nothing_prepared_key_waits:",
        runtime.shared_nothing_prepared_key_waits,
    );
    write_info_u64(
        buf,
        b"shared_nothing_prepared_key_retries:",
        runtime.shared_nothing_prepared_key_retries,
    );
    write_info_u64(
        buf,
        b"shared_nothing_prepared_key_wait_nanos_total:",
        runtime.shared_nothing_prepared_key_wait_nanos_total,
    );
    write_info_u64(
        buf,
        b"shared_nothing_prepared_key_wait_nanos_max:",
        runtime.shared_nothing_prepared_key_wait_nanos_max,
    );
    write_info_u64(
        buf,
